...
def main(root, all_data):
    ...
    import Noob_Sleep
    import Noob_Diaper
    # import noob_frames as frames

    from noob_button_functions import clear_frame, create_frame, create_combo, forget_frame, button_builder
    ...
    main_menu = {"food_button" : {"name" : "Food", "window" : root, "column" : 0, "row" :0, "sticky" : "new", "command" : lambda: create_combo(tframegrid1,top_frame_1,food_menu1, tframe_list)},
            "sleep_button" : {"name" : "Sleep", "window" : root, "column" : 0, "row" :1, "sticky" : "new", "command" : lambda: create_combo(tframegrid1,top_frame_1, sleep_menu1, tframe_list)},
            "diaper_button" : {"name" : "Diaper", "window" : root, "column" : 0, "row" :2, "sticky" : "new", "command" : lambda: create_combo(tframegrid1,top_frame_1, diaper_menu1, tframe_list)},
            "milestones" : {"name" : "Milestones", "window" : root, "column" : 0, "row" :3, "sticky" : "new", "command" : lambda: create_combo(tframegrid1,top_frame_1, milestones1, tframe_list)},
            "activities" : {"name" : "Activities", "window" : root, "column" : 0, "row" :4, "sticky" : "new", "command" : lambda: create_combo(tframegrid1,top_frame_1, activities1, tframe_list)},
            "profile_button" : {"name" : "Profile", "window" : root, "column" : 0, "row" :5, "sticky" : "new", "command" : lambda: create_combo(tframegrid1,top_frame_1, profile1, tframe_list)},
            }

    food_menu1 = {"Liquid" : { "name" : "Liquid", "window" : top_frame_1, "column" : 0, "row" :0, "sticky" : "new", "command" : lambda:Noob_Milk.main(root,all_data) }, 
            "Solids" : { "name" : "Solids", "column" : 0, "row" :1, "sticky" : "new", "window" : top_frame_1, "command" : lambda: Noob_Milk.main(root,all_data)}
            }
    ...
    sleep_menu1 = {"Short Nap" : { "name" : "Short Nap", "window" : top_frame_1, "column" : 0, "row" :0, "sticky" : "new", "command" : lambda: Noob_Sleep.main(root,all_data)}, 
                     "Full Sleep" : { "name" : "Full Sleep", "window" : top_frame_1, "column" : 0, "row" :1, "sticky" : "new", "command" : lambda: Noob_Sleep.main(root,all_data)}
                     }

    diaper_menu1 = {"Yellow" : { "name" : "Yellow", "window" : top_frame_1, "column" : 0, "row" :0, "sticky" : "new", "command" : lambda: Noob_Diaper.main(root, all_data, "yellow")}, 
                    "Brown" : { "name" : "Brown", "window" : top_frame_1, "column" : 0, "row" :1, "sticky" : "new", "command" : lambda: Noob_Diaper.main(root, all_data, "brown")}
                      }
